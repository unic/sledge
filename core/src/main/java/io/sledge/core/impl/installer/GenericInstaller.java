...
/**
 * Installs generic packages such as CRX/Vault package or simly an OSGi bundle.
 */
    ...
    public void install(ApplicationPackage appPackage) throws InstallationException {
        ...
        try {
            ...
            if (!packageResourceExists(packageResourcePath)) {
                ...
                LOG.warn("Package: " + packageResourcePath + " has not been installed because it exists already. If you want to update your application, please uninstall first.");
            }
